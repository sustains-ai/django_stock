#!/usr/bin/env python
"""
Script to create migrations for the SaaS schema.
This handles the interactive prompts automatically.
"""
...
migration_content = '''# Generated migration for SaaS schema
...
migration_file = 'portfolio/migrations/0002_saas_schema.py'
